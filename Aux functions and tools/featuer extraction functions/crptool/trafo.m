...
%
% $Date: 2019/09/19 08:07:15 $
% $Revision: 2.5 $
%
% $Log: trafo.m,v $
% Revision 2.5  2019/09/19 08:07:15  marwan
...
for k = 1:cols
    ...
    switch a
      ...
      case 0
        ...
        verteilung=interp1(fs,i,[1:length(fs)],'nearest','extrap')';

      case 1
        verteilung=(-1:2/(N(1)-1):1)';

      case 2
        verteilung=sort(exprnd(expfit(hist(x(:,k),30)),N(1),1));
