...
%    to apply a correction schema for border lines, 
...
%                    (most commonly used approach until 2021)
...
%
% $Log: crqa.m,v $
% Revision 5.66  2021/11/25 11:04:49  marwan
% bug in GUI in crqa fixed
%
% Revision 5.65  2021/11/23 13:49:06  marwan
...
errcode=1;
   ...
   check_borderline_corr={'al','ce','ke'}; % all, censi, kelo
   ...
   if nargin & ischar(varargin{1})
        ...
        h=findobj('Tag','crqa_borderline');
        borderline_corr_n = get(h(1),'Value');
        borderline_corr = borderline_corr_str{borderline_corr_n};
       ...
       % check the text input parameters for method, gui 
        ...
        if ~isempty(i_char)
             for i=1:length(i_char), 
                ...
                temp_border = temp_border+strcmpi(varargin{i_char(i)}(1:2),check_borderline_corr'); 
             end
             borderline_corr_n=min(find(temp_border));
             ...
             if isempty(borderline_corr_n), borderline_corr_n=1; end
             if nogui>2, nogui=1; end
             if method_n>length(check_meth), method0=length(check_meth); end
             method=check_meth{method_n};
             borderline_corr = check_borderline_corr{borderline_corr_n};
        else
             nogui=0;
             if nargout
                nogui=1;
...
case 'init'
  ...
  h2=textwrap(h,{[char(169),' AGNLD'],'University of Potsdam','1998-2021'});
  set(h,'String',h2)
...
%%%%%%%%%%% embedding
  h=uicontrol(props.frame,...
            'Tag','frame',...
            'Position',[86+30 29.+2.8+.8 29 5.7]);    
 
  h=uicontrol(props.text,...
            'Tag','text',...
            'Fontangle','italic',...
            'String','Embedding parameters',...
            'Position',[87+30 34.2+1.6+.8 16.8333  1.5000]);    
 
  h=uicontrol(props.text,...
            'Tag','text',...
            'String','Dimension:',...
            'Position',[89+30 32+2.2+.8 16.8333  1.5000]);    

  h=uicontrol(props.edit,...
            'Tag','crqa_m',...
            'String',num2str(m),...
            'ToolTip','Select the embedding dimension.',...
            'Position',[104+30 32+.2+2.2+.8 7  1.5000]);    

  h=uicontrol(props.text,...
            'Tag','text',...
            'String','Delay:',...
            'Position',[89+30 30+2.32+.8 16.8333  1.5000]);    

  h=uicontrol(props.edit,...
            'Tag','crqa_maxLag',...
            'String',num2str(t),...
            'ToolTip','Insert the embedding delay time.',...
            'Position',[104+30 30+.2+2.32+.8 7  1.5000]);    

%%%%%%%%%%% neigbourhood
  h=uicontrol(props.frame,...
            'Tag','frame',...
            'Position',[86+30 21.9+2.5+.9 29 6.7]);    
 
  h=uicontrol(props.text,...
            'Tag','text',...
            'Fontangle','italic',...
            'String','Neighbourhood',...
            'Position',[87+30 26.8+2.5+.8 23  1.5000]);    
  ...
  h=uicontrol(props.popup,...
            ...
            'Position',[89+30 24.6+.2+2.5+.8 22  1.7]);    

  h=uicontrol(props.text,...
            'Tag','text',...
            'String','Threshold:',...
            'Position',[89+30 22.6+2.5+.8 16.8333  1.5]);    

  h=uicontrol(props.edit,...
            'Tag','crqa_eps',...
            'String',num2str(e),...
            'ToolTip','Insert the size of neighbourhood.',...
            'Position',[104+30 22.6+.2+2.5+.8 7  1.5000]);    

%%%%%%%%%%% crqa parameters
  h=uicontrol(props.frame,...
            'Tag','frame',...
            'Position',[86+30 11+.5-.3 29 12.2+1.3]);    
 
  h=uicontrol(props.text,...
            'Tag','text',...
            'Fontangle','italic',...
            'String','CRQA parameters',...
            'Position',[87+30 19.5+3.5 23  1.5000]);    

  h=uicontrol(props.text,...
            'Tag','text',...
            'String','min. Diagonal:',...
            'Position',[89+30 17.8+3.5 16.8333  1.5]);    

  h=uicontrol(props.edit,...
            'Tag','crqa_lmin',...
            'String',num2str(lmin),...
            'ToolTip','Insert the minimal length of a diagonal line.',...
            'Position',[104+30 17.8+.2+3.5 7  1.5000]);    

  h=uicontrol(props.text,...
            'Tag','text',...
            'String','min. Vertical:',...
            'Position',[89+30 15.9+3.5 16.8333  1.5]);    

  h=uicontrol(props.edit,...
            'Tag','crqa_vmin',...
            'String',num2str(vmin),...
            'ToolTip','Insert the minimal length of a vertical line.',...
            'Position',[104+30 15.9+.2+3.5 7  1.5000]);    

  h=uicontrol(props.text,...
            'Tag','text',...
            'String','Theiler wind.:',...
            'Position',[89+30 16.0+1.5 16.8333  1.5]);    

  h=uicontrol(props.edit,...
            'Tag','crqa_theiler',...
            'String',num2str(theiler_window),...
            'ToolTip','Insert the size for the Theiler window.',...
            'Position',[104+30 16.0+.2+1.5 7  1.5000]);    
  if x~=y; set(h,'enable','off'); end

  h=uicontrol(props.text,...
            'Tag','text',...
            'String','Window size:',...
            'Position',[89+30 14.1+1.5 16.8333  1.5]);    

  h=uicontrol(props.edit,...
            'Tag','crqa_w',...
            'String',num2str(w),...
            'ToolTip','Insert the size of the sliding window.',...
            'Position',[104+30 14.1+.2+1.5 7  1.5000]);    

  h=uicontrol(props.text,...
            'Tag','text',...
            'String','Window step:',...
            'Position',[89+30 12.2+1.5 16.8333  1.5]);    

  h=uicontrol(props.edit,...
            'Tag','crqa_ws',...
            'String',num2str(wstep),...
            'ToolTip','Insert the step width for sliding the window.',...
            'Position',[104+30 12.2+.2+1.5 7  1.5000]);    

  h=uicontrol(props.text,...
            'Tag','text',...
            'String','Correction schema:',...
            'Position',[89+30 10.8+1. 16.8333  1.5]);    

  h=uicontrol(props.popup,...
            'Tag','crqa_borderline',...
            'String',num2str(wstep),...
            'Value',borderline_corr_n,...
            'String','all|Censi|KELO',...
            'ToolTip','Borderline correction schema.',...
            'Position',[104+29 10.8+.2+1. 10  1.5000]);    
...
%%%%%%%%%%% buttons
  ...
  h=uicontrol(props.button,...
              ...
              'Enable','Off',...
                ...
                'Callback','crqa store',...
                'Position',[100.5+30  7.4+.2 10.5  2.2143]);
  ...
  h=uicontrol(props.button,...
            ...
            'String','Print',...
            'Position',[89+30  7.4+.2 10.5  2.2143]);    
  ...
  h=uicontrol(props.button,...
            ...
            'String','Close',...
            'Position',[89+30  2.1+.2 22  2.2143]);    
...
for i=1:wstep:Nx-w+1; 
     ...
     % use builtin implementation
         ...
         % transitivity
         X_theiler2 = double(X_theiler) * double(X_theiler);
         denom = sum(sum(X_theiler2)) - trace(X_theiler2); % sum with removed main diagonal
